This is a personal website. I try to collect as little information about you as possible, and I never sell, share or trade any data with third parties for marketing purposes.

## Who is responsible

This site is owned and operated by Danny Smith, a sole individual based in the United Kingdom. For any privacy-related questions, write to [hi@danny.is](mailto:hi@danny.is).

## What I collect

**Analytics.** I use [Simple Analytics](https://simpleanalytics.com) to understand how many people visit the site and which pages they read. Simple Analytics is a privacy-friendly, EU-based service that:

- Does **not** use cookies or any other form of persistent identifier.
- Does **not** collect or store personal data, IP addresses, fingerprints, or device IDs.
- Aggregates data into anonymous, page-level statistics.
...
- Ask what data I hold about you (almost certainly: none).
- Ask me to correct or delete any data I do hold.
- Complain to the [UK Information Commissioner's Office](https://ico.org.uk/) or your local data protection authority.

To exercise any of these rights, email [hi@danny.is](mailto:hi@danny.is).
