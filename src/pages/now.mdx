...
import { CurrentlyReading } from '@components/ui/index'
...
- Occasionally adding to my [collection of tools and frameworks](/toolbox).
- Playing at Open Mic nights in my local pub.
- Living in a lovely little mews in Islington, North London.

## Currently reading

I'm currently reading these books according to my [Bookhive profile](https://bookhive.buzz/profile/danny.is).
