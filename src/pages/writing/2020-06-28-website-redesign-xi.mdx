...
<Image src={image1} alt="Fira Code Ligature Sample" />
<Image src={image2} alt="Fira Code Typography Sample" />
...
<Image src={image3} alt="Fira Code Stylistic Settings" />
...
<Image src={image4} alt="Screenshot of code block" />
...
<Image src={image5} alt="Horizontal Rule" />
