...
import image1 from '@uploads/2020-06-25-links-desktop.png'
import image2 from '@uploads/2020-06-25-link-visited-desktop.png'
import image3 from '@uploads/2020-06-25-link-activehover.png'
import image4 from '@uploads/2020-06-25-links-mobile.png'
import image5 from '@uploads/2020-06-25-squint.png'
import image6 from '@uploads/iso-link-focus.png'
...
<Image src={image1} alt="Links with coloured underlines" />

<Image src={image2} alt="Visited link with coloured underline" />

The hover styles can afford to be a lot bolder and brighter. Something like...

<Image src={image3} alt="Active and Hover style for links" />
...
<Image src={image4} alt="Mobile Links" />

<Image src={image5} alt="Squint Test" />
...
<Image src={image6} alt="Outline Example]" />
