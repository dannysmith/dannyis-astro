...
import image1 from '@uploads/literata-optical-sizes.png'
import image2 from '@uploads/2020-06-18-font-tree.png'
import image3 from '@uploads/2020-06-19-heading-ligs.png'
import image4 from '@uploads/2020-06-19-final-screenshots.png'
...
<Image src={image1} alt="Optical sizes" />
...
<Image src={image2} alt="Screenshot of file tree in fonts directory" />
...
<Image src={image3} alt="Screenshot of discretionary ligatures in heading" />

## So where are we at?

<Image src={image4} alt="Comparison of Literata and Lora applied to an essay" />
