...
import image from '@uploads/2020-07-02-hot-air-baloon.jpg'
...
<Image src={image} alt="Hot air ballon in the sky" />
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/4-d_SoCHeWE"
  frameborder="0"
...
<Image src={image} alt="Hot air ballon in the sky" class="bleed-full" />
...
<Image src={image} alt="Hot air ballon in the sky" class="bleed-left" />

### An image at right-bleed

Donec feugiat sagittis velit non molestie. Nullam mattis erat eget elit faucibus, ac tincidunt ligula bibendum. Suspendisse potenti. Nunc et aliquet nunc.

<Image src={image} alt="Hot air ballon in the sky" class="bleed-right" />
