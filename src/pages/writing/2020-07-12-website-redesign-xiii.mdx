...
import image1 from '@uploads/2020-07-11-postit-content-unorganised.png'
import image2 from '@uploads/2020-07-11-postit-content-type.png'
import image3 from '@uploads/2020-07-11-postit-create-consume.png'
import image4 from '@uploads/2020-07-11-postit-content-personalprofessional.png'
import image5 from '@uploads/2020-07-11-postit-content-importance.png'
import image6 from '@uploads/2020-07-11-postit-content-permenance.png'
import image7 from '@uploads/2020-07-11-postit-content-themes.png'
import image8 from '@uploads/2020-07-11-postit-content-themes-super.png'
...
<Image src={image1} alt="Post-it notes of content audit - unorganised" />
...
<Image src={image2} alt="Post-it notes of content audit - by type" />
...
<Image src={image3} alt="Post-it notes of content audit - by author" />
...
<Image
  src={image4}
  alt="Post-it notes of content audit - by professional or personal"
/>

![](/uploads/2020-07-11-postit-content-personalprofessional.png)
...
<Image src={image5} alt="Post-it notes of content audit - by importance" />
...
One of the main reasons I'm moving my writing to my own blog is permanence. As I said in Part I, I don't like the fact that Medium controls my content and URLs. I want a more permanent place to put my words. Somewhere they can live forever – **etched in stone**, as it were.
...
<Image src={image6} alt="Post-it notes of content audit - by permanence" />
...
<Image src={image7} alt="Content Categories" />
...
<Image src={image8} alt="Content Super Categories" />
