...
import image1 from '@uploads/2020-06-21-baseline1.png'
import image2 from '@uploads/2020-06-21-baseline2.png'
import image3 from '@uploads/2020-06-21-baseline-margins.png'
import image4 from '@uploads/2020-06-22-heading-type.png'
...
<Image src={image1} alt="Example 1: aligning text to a baseline" />
<Image src={image2} alt="Example 2: aligning text to a baseline" />
...
<Image src={image3} alt="Example: spacing with a baseline grid" />
...
<Image src={image4} alt="Screenshot of headings" />
