...
import image1 from '@uploads/A_Figures.png'
import image2 from '@uploads/2020-06-22-drop-cap.png'
...
<Image src={image1} alt="A_Figures" />
...
<Image src={image2} alt="Example: Drop Caps" />
