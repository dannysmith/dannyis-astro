...
1. **Cutting Tools** 🔪 - Knives, saws and axes are almost impossible to make in the outdoors, but allow us to crate all sorts of other tools.
...
The list below is fairly compressive - you can think of it as my default *cover-all-bases* "load out". I tweak it depending on where I'm going and what I intend to do.
...
- **Base layer** - Billy basic thin merino wool long-sleeved T-shirts. Fancy "technical" base layers are overrated. Wool is naturally wicking, antimicrobial and stays warm when damp. With a loose enough weave, thin wool T-shirts breath well in the heat and are warm in the cold when covered with another layer. I only wear normal cotton T-shirts on short day-hikes.
...
- **Wooly hat** - actual wool, in drybag along with any other warm gloves/scarves if it's cold. I often sleep in this.
...
- Millitary issued **waterproof trousers** - rare that I take these because my normal trousers dry so fast.
...
- **Camelback** - Bladders are great because they make it easy to stay hydrated while on the move, but they're less practical than bottles when spending time in camp. When it's hot or I know I'll be moving fast, this lives in it's case on the side of my Karrimor pack or "naked" in the bladder compartment of my Osprey pack. When detached, the case has built-in straps for wear on it's own while my main pack is in camp. It can be turned inside out for easy cleaning.
...
- **Frying pan** – one of these two:
  - A cheap 6" camping **frying pan** with folding handle. This doubles as a plate, small sink or (upside down) chopping board. But it's too thin to get an even heat and so it rubbish for cooking a decent fresh meal.
...
- **Food** in dry bag. Includes *at least*...
  ...
  - Small salt & pepper shaker & tiny bottle of tobasco sauce.
...
- **Belt knife** - One of two fixed-blade knives, both with a scandi grind for easy sharpening and a 90° spine for striking ferro rods…
  - A beautiful [TBS Bushcraft Knife](https://www.thebushcraftstore.co.uk/tbs-knives--350-c.asp) – super versatile and an absolute joy to use, but something I'd hate to loose. Great for heavy work like battening and finer work with the tip.
  - A cheap £15 Moura – way lighter but otherwise almost as good… and which I don't mind loosing or breaking!
- **Ferro rod** - A chunky ferro rod with a gorilla tape handle. Tape can be used for fixing stuff, or as tinder in a pinch.
- **Axe** - Beautiful Gransfors Burk Forest Axe, which is just long enough for heavier work and short enough to fit *inside* my pack. It's also got a pronounced "beard" so you can choke up right behind the blade for finer work.
- **Saw** - Bacho laplander. It's small, compact and fits in a pocket. Very flexible stainless steel blade but with hardened teeth so it's much more forgiving than a silky.
...
- **"Bits bag"** containing at least...
  ...
  - Small barocca tube wrapped in 1.5m gorilla tape containing:
