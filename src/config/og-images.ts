...
export const OG_IMAGE_PAGES: OgImagePage[] = [
  ...
  { path: '/using', title: 'Stuff I use' },
  { path: '/using/bag', title: 'My bag & its contents' },
  { path: '/using/office', title: 'My Home Office & Desk' },
  { path: '/using/outdoors', title: 'My Outdoor Kit' },
  { path: '/using/software', title: 'Software I use' },
