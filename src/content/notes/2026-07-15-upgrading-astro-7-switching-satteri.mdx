...
I've just upgraded this site to [Astro 7](https://astro.build/blog/astro-7/), including switching from remark to [Sätteri](https://satteri.bruits.org/), which is now the default markdown parser.

The actual [Astro upgrade](https://github.com/dannysmith/dannyis-astro/commit/e0db857f4fac0d00e08b4029e21bf9b65135dc08) was pretty painless since I did it before switching the markdown parser. The switch to Sätteri was a little more complex because I had a bunch of remark plugins which needed migrating to [MDAST or HAST](https://satteri.bruits.org/docs/plugins/) plugins. This is exactly the sort of job that AI coding agents make fairly painless.

## MDAST Plugins

I now have the following MDAST plugins on this site. These work on the markdown syntax tree (ie nodes represent markdown/MDX syntax).
...
These work on the *HTML* syntax tree and so transform the HTML *after* Sätteri has done its stuff.
