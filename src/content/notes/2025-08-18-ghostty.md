...
I understand why – nobody ever got rich by building a terminal app. But when a mistyped `ls -a` causes my terminal to say "You're absolutely right - let me search online for a better solution" I'm gonna look for a terminal which is **just a fucking terminal**.
