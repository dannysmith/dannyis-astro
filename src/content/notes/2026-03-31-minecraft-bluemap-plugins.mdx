...
![BlueMap view with chunkbase-style structure markers overlaid on the world map](../../assets/notes/2026-03-31-mc-bluemap-structures.png)
...
![Heatmap overlay on BlueMap's flat view, with chunks coloured by inhabited time](../../assets/notes/2026-03-31-mc-bluemap-chunky-heatmap.png)
...
![Chunk Selector mode in BlueMap, with several chunks highlighted as selected for trimming](../../assets/notes/2026-03-31-mc-bluemap-chunky-selector.png)
...
![mc-infra monitoring dashboard showing the status of running Minecraft servers](../../assets/notes/2026-03-31-mc-infra-dashboard.png)

![mc-infra world data view showing per-world details and stats](../../assets/notes/2026-03-31-mc-infra-worlddata.png)
