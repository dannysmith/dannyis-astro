...
1. It's slightly slower to respond to keypresses than Wispr, which means I often lose the first or last word of a dictation.
...
Despite that, if you're paying for Wispr or [SuperWhisper](https://superwhisper.com/) or similar, check out [VoiceInk](https://tryvoiceink.com/).
