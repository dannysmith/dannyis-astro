...
While building [Astro Editor](https://astroeditor.danny.is) I learned a fair bit about Tauri and how to develop simple macOS/React apps with it using Claude Code.
...
- A command system with a command palette, macOS menus and keyboard shortcuts
...
- A preferences pane and preferences persistence system
...
This is mainly meant for **me** to use as a starting point when building other macOS apps with Tauri & React.
