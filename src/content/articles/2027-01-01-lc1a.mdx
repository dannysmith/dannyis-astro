...
1. **I don't own the canonical URLs for my videos.** I've got many hundreds of historical Loom videos, many of which are embedded in documents, wikis, knowledge bases and archived slack channels in organisations I've long-since left. Every one of them points to `loom.com/something`, so while I own my actual videos (I can download them), Loom controls what matters most for content on the web: *the canonical URLs*.
2. **I don't have much control over the viewer experience.** Loom controls how my videos are served to viewers: It's impossible for me to control things like RSS feeds, custom embedded players, SEO and text-based endpoints to the degree I want.
...
3. **The admin app**. A web interface which lets me manage, organise and edit my online videos, optimised to speed up the workflows I care most about personally.

4. **The viewer-facing surface**. Serves the video URLs to viewers along with discovery-focussed stuff like SEO and RSS feeds. This is all the public-facing stuff.

The rest of this article covers the **recording app**'s UI and demos the main features of the **viewer-facing surface** and **admin app**. We'll go into detail about *how* these work in subsequent articles – for now I just wanna explain *what* they all do right now.

## The macOS recording app

The menubar app is deliberately very simple. Clicking it opens a popover like this.

![The LoomClone menubar popover showing display, camera and mic selectors, a recording preview, a sound meter, white balance and brightness sliders, and the starting-mode, quality and framerate controls](../../assets/articles/2026-07-06-lc-menubar-app-1.png)

| Control | Description |
| ------- | ----------- |
| Display selector | Select the monitor to use when showing the screen |
...
![A recording in picture-in-picture mode with a circular camera preview overlaid in the corner of the screen](../../assets/articles/2026-07-06-lc-recording-pip.png)
![A recording in camera-only mode with a large rectangular camera preview](../../assets/articles/2026-07-06-lc-recording-camonly.png)
...
![A LoomClone video embedded and playing inline within a Notion page](../../assets/articles/2026-07-06-lc-embedding-notion.png)

![A LoomClone video link shared in WhatsApp showing a rich preview with thumbnail and title](../../assets/articles/2026-07-06-lc-whatsapp-share.png)
...
![A public tag page on v.danny.is listing several videos as a collection or playlist](../../assets/articles/2026-07-07-lc-tagpage-public-demo.png)
