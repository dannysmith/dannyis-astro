...
Here is one with a large heading and some richer content...

<Callout title="Rich content with a large heading" icon="heroicons:document-text-20-solid" largeHeading>
Callouts can hold anything you'd write elsewhere: **bold**, *italic* and [links](http://example.com).
Lists work too:
- Bullet points
- Numbered lists
- Any nesting you need
</Callout>
...
Markdown images (which become `BasicImage` figures) placed inside a `Grid` render as a side-by-side gallery. Captions and the lightbox are preserved, and the figures flow into the grid's columns instead of pinning to the prose column.

<Grid columns={2}>
![Wooden deck with striped columns and glass panels](../../assets/articles/styleguide-image.jpg 'A caption on the left')

![Wooden deck with striped columns and glass panels](../../assets/articles/styleguide-image.jpg 'A caption on the right')
</Grid>

<Grid columns={3}>
![Wooden deck with striped columns and glass panels](../../assets/articles/styleguide-image.jpg 'One')

![Wooden deck with striped columns and glass panels](../../assets/articles/styleguide-image.jpg 'Two')

![Wooden deck with striped columns and glass panels](../../assets/articles/styleguide-image.jpg 'Three')
</Grid>
