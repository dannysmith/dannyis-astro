...
When used as an SSG, Astro is also very simple. File-based routing, markdown parsing and YAML frontmatter Just Work™ and stuff like image optimisation come out-of-the-box. And while composing pages from astro components *feels* very Reactish, it's "zero Javascript by default" – the generated site will only include client-side JS when nececarry, which for this site is hardly ever.
